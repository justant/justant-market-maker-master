...
from market_maker.utils import log, constants, errors, math, common_util
...
class ExchangeInterface:
    ...
    def cancel_order(self, order):
        logger.info("[ExchangeInterface][cancel_order]")
    ...
    def get_portfolio(self):
        logger.info("[ExchangeInterface][get_portfolio]")
    ...
    def calc_delta(self):
        logger.info("[ExchangeInterface][calc_delta]")
    ...
    def get_delta(self, symbol=None):
        logger.info("[ExchangeInterface][get_delta]")
    ...
    def get_lowest_sell(self):
        logger.info("[ExchangeInterface][get_lowest_sell]")
    ...
    def amend_bulk_orders(self, orders):
        logger.info("[ExchangeInterface][amend_bulk_orders]")
    ...
    def create_bulk_orders(self, orders):
        logger.info("[ExchangeInterface][create_bulk_orders]")
...
class OrderManager():
    ...
    def get_ticker(self):
        logger.info("[OrderManager][get_ticker]")
    ...
    def get_price_offset(self, index):
        logger.info("[OrderManager][get_price_offset]")
    ...
    def place_orders(self):
        logger.info("[OrderManager][place_orders]")
    ...
    def prepare_order(self, index):
        logger.info("[OrderManager][prepare_order]")
    ...
    def converge_orders(self, buy_orders, sell_orders):
        logger.info("[OrderManager][converge_orders]")
    ...
    def short_position_limit_exceeded(self):
        logger.info("[OrderManager][short_position_limit_exceeded]")
    ...
    def long_position_limit_exceeded(self):
        logger.info("[OrderManager][long_position_limit_exceeded]")
    ...
    def sanity_check(self):
        logger.info("[OrderManager][sanity_check]")
